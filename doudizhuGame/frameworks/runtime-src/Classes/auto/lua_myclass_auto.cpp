...
int lua_myclass_PokerExhibitionZone_chuPai(lua_State* tolua_S)
{
    int argc = 0;
    PokerExhibitionZone* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_myclass_PokerExhibitionZone_chuPai'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_std_vector_int(tolua_S, 2, &arg0, "PokerExhibitionZone:chuPai");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_myclass_PokerExhibitionZone_chuPai'", nullptr);
            return 0;
        }
        cobj->chuPai(arg0);
        return 0;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "PokerExhibitionZone:chuPai",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_myclass_PokerExhibitionZone_chuPai'.",&tolua_err);
#endif
...
int lua_register_myclass_PokerExhibitionZone(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"PokerExhibitionZone");
        ...
        tolua_function(tolua_S,"chuPai",lua_myclass_PokerExhibitionZone_chuPai);
...
int lua_myclass_Poker_init(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_int32(tolua_S, 2,(int *)&arg0, "Poker:init");
        if(!ok)
        {
...
int lua_myclass_Poker_getTypeIndex(lua_State* tolua_S)
{
    int argc = 0;
    Poker* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_myclass_Poker_getTypeIndex'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_myclass_Poker_getTypeIndex'", nullptr);
            return 0;
        }
        int ret = cobj->getTypeIndex();
        tolua_pushnumber(tolua_S,(lua_Number)ret);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "Poker:getTypeIndex",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_myclass_Poker_getTypeIndex'.",&tolua_err);
#endif
...
int lua_myclass_Poker_create(lua_State* tolua_S)
{
    ...
    {
        int arg0;
        ok &= luaval_to_int32(tolua_S, 2,(int *)&arg0, "Poker:create");
        if(!ok)
        {
...
int lua_register_myclass_Poker(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"Poker");
        ...
        tolua_function(tolua_S,"getTypeIndex",lua_myclass_Poker_getTypeIndex);
